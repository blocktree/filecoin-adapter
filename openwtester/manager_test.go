...
var (
	...
	dbFileName = "blockchain-TESTFIL.db"
...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO TESTFIL", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W5Gfeiz9NB9HVGqMpNqWDZMm1XFAQv2TRT")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "TESTFIL-CHARGE-1", WalletID: walletID, Required: 1, Symbol: "TESTFIL", IsTrust: true}
